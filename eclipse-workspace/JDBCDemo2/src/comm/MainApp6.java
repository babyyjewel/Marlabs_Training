		...
		// TODO Auto-generated method stub
                try {
				   ...
				   System.out.println("Database Connected");
			    	...
			    	ResultSet rset= st.executeQuery("select name from employee where name not in ('Hary','Santhosh') order by name ");
					...
					//	System.out.print("  salary="+rset.getInt(1));
					//	System.out.print("  department ="+rset.getString(1));
					//	System.out.print(" dob="+rset.getDate(1));
					//	System.out.print("  address="+rset.getString(1));
					//	System.out.println(" ");
